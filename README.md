To generate a calendar using the Calendar.c:
...
For instance, typing this command **./calendar 3 1** will give you the same outputs contained in the **example** folder.
